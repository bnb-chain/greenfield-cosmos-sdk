...
var _ protoreflect.List = (*_QueryCurrentPlanResponse_1_list)(nil)

type _QueryCurrentPlanResponse_1_list struct {
	list *[]*Plan
}

func (x *_QueryCurrentPlanResponse_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryCurrentPlanResponse_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QueryCurrentPlanResponse_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Plan)
	(*x.list)[i] = concreteValue
}

func (x *_QueryCurrentPlanResponse_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Plan)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryCurrentPlanResponse_1_list) AppendMutable() protoreflect.Value {
	v := new(Plan)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryCurrentPlanResponse_1_list) Truncate(n int) {
...
func (x *_QueryCurrentPlanResponse_1_list) NewElement() protoreflect.Value {
	v := new(Plan)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QueryCurrentPlanResponse_1_list) IsValid() bool {
	return x.list != nil
}
...
func (x *fastReflection_QueryCurrentPlanResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Plan) != 0 {
		value := protoreflect.ValueOfList(&_QueryCurrentPlanResponse_1_list{list: &x.Plan})
...
func (x *fastReflection_QueryCurrentPlanResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.upgrade.v1beta1.QueryCurrentPlanResponse.plan":
		if len(x.Plan) == 0 {
			return protoreflect.ValueOfList(&_QueryCurrentPlanResponse_1_list{})
		}
		listValue := &_QueryCurrentPlanResponse_1_list{list: &x.Plan}
...
func (x *fastReflection_QueryCurrentPlanResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.upgrade.v1beta1.QueryCurrentPlanResponse.plan":
		lv := value.List()
		clv := lv.(*_QueryCurrentPlanResponse_1_list)
		x.Plan = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.upgrade.v1beta1.QueryCurrentPlanResponse"))
...
func (x *fastReflection_QueryCurrentPlanResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.upgrade.v1beta1.QueryCurrentPlanResponse.plan":
		...
		value := &_QueryCurrentPlanResponse_1_list{list: &x.Plan}
...
func (x *fastReflection_QueryCurrentPlanResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.upgrade.v1beta1.QueryCurrentPlanResponse.plan":
		list := []*Plan{}
		return protoreflect.ValueOfList(&_QueryCurrentPlanResponse_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.upgrade.v1beta1.QueryCurrentPlanResponse"))
		}
...
func (x *fastReflection_QueryCurrentPlanResponse) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Plan) > 0 {
			for iNdEx := len(x.Plan) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.Plan[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				...
				x.Plan = append(x.Plan, &Plan{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.Plan[len(x.Plan)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
var file_cosmos_upgrade_v1beta1_query_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x75,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x32, 0xdc, 0x05,
	...
	0x75, 0x6c, 0x65, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0xda, 0x01, 0x0a,
	0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x75, 0x70, 0x67, 0x72,
	0x61, 0x64, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x0a, 0x51, 0x75, 0x65,
