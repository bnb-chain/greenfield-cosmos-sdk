...
var (
	...
	fd_GasInfo_rw_used       protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GasInfo_rw_used = md_GasInfo.Fields().ByName("rw_used")
}
...
func (x *fastReflection_GasInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.RwUsed != uint64(0) {
		value := protoreflect.ValueOfUint64(x.RwUsed)
		if !f(fd_GasInfo_rw_used, value) {
			return
		}
	}
}
...
func (x *fastReflection_GasInfo) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.base.abci.v1beta1.GasInfo.rw_used":
		return x.RwUsed != uint64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GasInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.base.abci.v1beta1.GasInfo.rw_used":
		panic(fmt.Errorf("field rw_used of message cosmos.base.abci.v1beta1.GasInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.abci.v1beta1.GasInfo"))
		}
...
func (x *fastReflection_GasInfo) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.RwUsed != 0 {
			n += 1 + runtime.Sov(uint64(x.RwUsed))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.RwUsed != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.RwUsed))
			i--
			dAtA[i] = 0x20
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 4:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field RwUsed", wireType)
				}
				x.RwUsed = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
...
var (
	...
	fd_TxMsgData_extra_data    protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_TxMsgData_extra_data = md_TxMsgData.Fields().ByName("extra_data")
}
...
func (x *fastReflection_TxMsgData) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.ExtraData) != 0 {
		...
		if !f(fd_TxMsgData_extra_data, value) {
			return
		}
	}
}
...
func (x *fastReflection_TxMsgData) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.base.abci.v1beta1.TxMsgData.msg_responses":
		return len(x.MsgResponses) != 0
	case "cosmos.base.abci.v1beta1.TxMsgData.extra_data":
...
func (x *fastReflection_TxMsgData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.base.abci.v1beta1.TxMsgData.msg_responses":
		...
		return protoreflect.ValueOfList(value)
	case "cosmos.base.abci.v1beta1.TxMsgData.extra_data":
		panic(fmt.Errorf("field extra_data of message cosmos.base.abci.v1beta1.TxMsgData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.abci.v1beta1.TxMsgData"))
		}
...
func (x *GasInfo) GetRwUsed() uint64 {
	if x != nil {
		return x.RwUsed
	}
	return 0
...
func (x *TxMsgData) GetExtraData() []byte {
	if x != nil {
		return x.ExtraData
	}
	return nil
...
var file_cosmos_base_abci_v1beta1_abci_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x80, 0x01, 0x0a, 0x07, 0x47, 0x61, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1d, 0x0a,
	...
	0x67, 0x61, 0x73, 0x55, 0x73, 0x65, 0x64, 0x12, 0x22, 0x0a, 0x0d, 0x6d, 0x69, 0x6e, 0x5f, 0x67,
	0x61, 0x73, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x6d, 0x69, 0x6e, 0x47, 0x61, 0x73, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x72,
	0x77, 0x5f, 0x75, 0x73, 0x65, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x72, 0x77,
	...
	0x61, 0x74, 0x61, 0x3a, 0x06, 0x80, 0xdc, 0x20, 0x01, 0x18, 0x01, 0x22, 0xa6, 0x01, 0x0a, 0x09,
	...
	0x79, 0x52, 0x0c, 0x6d, 0x73, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x73, 0x12,
	0x1d, 0x0a, 0x0a, 0x65, 0x78, 0x74, 0x72, 0x61, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x09, 0x65, 0x78, 0x74, 0x72, 0x61, 0x44, 0x61, 0x74, 0x61, 0x3a, 0x04,
	...
	0xdc, 0x20, 0x01, 0x42, 0xe7, 0x01, 0xd8, 0xe1, 0x1e, 0x00, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e,
	0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x61, 0x62, 0x63, 0x69,
	...
	0x41, 0x62, 0x63, 0x69, 0x3a, 0x3a, 0x56, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x62, 0x06, 0x70,
