...
const (
	Query_Params_FullMethodName       = "/cosmos.gashub.v1beta1.Query/Params"
	Query_MsgGasParams_FullMethodName = "/cosmos.gashub.v1beta1.Query/MsgGasParams"
)
...
func (c *queryClient) MsgGasParams(ctx context.Context, in *QueryMsgGasParamsRequest, opts ...grpc.CallOption) (*QueryMsgGasParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_MsgGasParams_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) MsgGasParams(context.Context, *QueryMsgGasParamsRequest) (*QueryMsgGasParamsResponse, error) {
...
func _Query_MsgGasParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_MsgGasParams_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
