...
var (
	...
	fd_Reveal_height    protoreflect.FieldDescriptor
	fd_Reveal_signature protoreflect.FieldDescriptor
)

func init() {
	file_tendermint_types_types_proto_init()
	md_Reveal = File_tendermint_types_types_proto.Messages().ByName("Reveal")
	fd_Reveal_height = md_Reveal.Fields().ByName("height")
	fd_Reveal_signature = md_Reveal.Fields().ByName("signature")
}
...
func (x *fastReflection_Reveal) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Height != int64(0) {
		value := protoreflect.ValueOfInt64(x.Height)
		if !f(fd_Reveal_height, value) {
			return
		}
	}
	if len(x.Signature) != 0 {
		value := protoreflect.ValueOfBytes(x.Signature)
		if !f(fd_Reveal_signature, value) {
			return
		}
	}
}
...
func (x *fastReflection_Reveal) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "tendermint.types.Reveal.height":
		return x.Height != int64(0)
	case "tendermint.types.Reveal.signature":
		return len(x.Signature) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.types.Reveal"))
		}
		panic(fmt.Errorf("message tendermint.types.Reveal does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Reveal) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message tendermint.types.Reveal does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Reveal) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "tendermint.types.Reveal.height":
		panic(fmt.Errorf("field height of message tendermint.types.Reveal is not mutable"))
	case "tendermint.types.Reveal.signature":
		panic(fmt.Errorf("field signature of message tendermint.types.Reveal is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.types.Reveal"))
		}
...
func (x *fastReflection_Reveal) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in tendermint.types.Reveal", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *Reveal) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
var file_tendermint_types_types_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1e, 0x74, 0x65, 0x6e, 0x64, 0x65, 0x72,
	0x6d, 0x69, 0x6e, 0x74, 0x2f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x2f, 0x74, 0x79, 0x70,
	0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x39, 0x0a, 0x0d, 0x50, 0x61, 0x72, 0x74,
	...
	0x22, 0x3e, 0x0a, 0x06, 0x52, 0x65, 0x76, 0x65, 0x61, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x65,
...
var file_tendermint_types_types_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
...
var file_tendermint_types_types_proto_depIdxs = []int32{
	...
	18, // 14: tendermint.types.Proposal.timestamp:type_name -> google.protobuf.Timestamp
	...
	19, // 18: tendermint.types.LightBlock.validator_set:type_name -> tendermint.types.ValidatorSet
	...
	16, // 21: tendermint.types.TxProof.proof:type_name -> tendermint.crypto.Proof
