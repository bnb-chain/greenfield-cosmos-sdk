...
func TestMsgUrl(t *testing.T) {
	defaultMsgGasParamsSet := []*types.MsgGasParams{
		...
		types.NewMsgGasParamsWithFixedGas("/bnbchain.greenfield.storage.MsgMirrorBucket", 12e3),
		types.NewMsgGasParamsWithFixedGas("/bnbchain.greenfield.storage.MsgCreateGroup", 12e3),
		types.NewMsgGasParamsWithFixedGas("/bnbchain.greenfield.storage.MsgMirrorGroup", 12e3),
		types.NewMsgGasParamsWithFixedGas("/bnbchain.greenfield.storage.MsgCreateObject", 12e3),
		types.NewMsgGasParamsWithFixedGas("/bnbchain.greenfield.storage.MsgMirrorObject", 12e3),
