...
func (sh *Helper) Delegate(delegator sdk.AccAddress, val sdk.AccAddress, amount math.Int) {
	coin := sdk.NewCoin(sh.Denom, amount)
...
func (sh *Helper) DelegateWithPower(delegator sdk.AccAddress, val sdk.AccAddress, power int64) {
...
func (sh *Helper) Undelegate(delegator sdk.AccAddress, val sdk.AccAddress, amount math.Int, ok bool) {
...
func (sh *Helper) CheckDelegator(delegator sdk.AccAddress, val sdk.AccAddress, found bool) {
