...
func NewStakeAuthorization(allowed []sdk.AccAddress, denied []sdk.AccAddress, authzType AuthorizationType, amount *sdk.Coin) (*StakeAuthorization, error) {
...
func validateAllowAndDenyValidators(allowed []sdk.AccAddress, denied []sdk.AccAddress) ([]string, []string, error) {
