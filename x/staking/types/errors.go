...
var (
	...
	ErrValidatorRelayerAddressExists   = sdkerrors.Register(ModuleName, 43, "validator already exist for this relayer address; must use new relayer address")
	ErrValidatorRelayerInvalidBlsKey   = sdkerrors.Register(ModuleName, 44, "validator relayer bls pubkey is invalid")
	ErrValidatorRelayerBlsKeyExists    = sdkerrors.Register(ModuleName, 45, "validator already exist for this relayer bls pubkey; must use new bls pubkey")
	ErrDelegationNotAllowed            = sdkerrors.Register(ModuleName, 46, "delegation is not allowed")
	ErrRedelegationNotAllowed          = sdkerrors.Register(ModuleName, 47, "redelegation is not allowed")
	ErrInvalidSigner                   = sdkerrors.Register(ModuleName, 48, "invalid signer")
	ErrInvalidMinSelfDelegation        = sdkerrors.Register(ModuleName, 49, "invalid minimum self delegation, must no less than the chain level minimum self delegation")
)
