...
var (
	...
	ErrValidatorRelayerAddressExists   = errors.Register(ModuleName, 43, "validator already exist for this relayer address; must use new relayer address")
	ErrValidatorRelayerInvalidBlsKey   = errors.Register(ModuleName, 44, "validator relayer bls pubkey is invalid")
	ErrValidatorRelayerBlsKeyExists    = errors.Register(ModuleName, 45, "validator already exist for this relayer bls pubkey; must use new bls pubkey")
