...
var (
	...
	ErrValidatorChallengerAddressExists = errors.Register(ModuleName, 44, "validator already exist for this challenger address; must use new relayer address")
	ErrValidatorInvalidBlsKey           = errors.Register(ModuleName, 45, "validator bls pubkey is invalid")
	ErrValidatorBlsKeyExists            = errors.Register(ModuleName, 46, "validator already exist for this bls pubkey; must use new bls pubkey")
	ErrDelegationNotAllowed             = errors.Register(ModuleName, 47, "delegation is not allowed")
