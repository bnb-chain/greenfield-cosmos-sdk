...
var (
	...
	ErrValidatorRelayerAddressExists    = errors.Register(ModuleName, 41, "validator already exist for this relayer address; must use new relayer address")
	ErrValidatorChallengerAddressExists = errors.Register(ModuleName, 42, "validator already exist for this challenger address; must use new relayer address")
	ErrValidatorInvalidBlsKey           = errors.Register(ModuleName, 43, "validator bls pubkey is invalid")
	ErrValidatorBlsKeyExists            = errors.Register(ModuleName, 44, "validator already exist for this bls pubkey; must use new bls pubkey")
	ErrDelegationNotAllowed             = errors.Register(ModuleName, 46, "delegation is not allowed")
	ErrRedelegationNotAllowed           = errors.Register(ModuleName, 47, "redelegation is not allowed")
	ErrInvalidSigner                    = errors.Register(ModuleName, 48, "invalid signer")
	ErrInvalidMinSelfDelegation         = errors.Register(ModuleName, 49, "invalid minimum self delegation, must no less than the chain level minimum self delegation")
)
