...
var (
	...
	ErrInvalidMinSelfDelegation         = sdkerrors.Register(ModuleName, 48, "invalid minimum self delegation, must no less than the chain level minimum self delegation")
)
