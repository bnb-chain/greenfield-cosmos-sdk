...
func (m *MockValidatorSet) Delegation(arg0 types.Context, arg1, arg2 types.AccAddress) types1.DelegationI {
	m.ctrl.T.Helper()
...
func (m *MockValidatorSet) Validator(arg0 types.Context, arg1 types.AccAddress) types1.ValidatorI {
	m.ctrl.T.Helper()
