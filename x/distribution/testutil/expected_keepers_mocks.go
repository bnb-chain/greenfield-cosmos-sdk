...
func (m *MockStakingKeeper) Delegation(arg0 types.Context, arg1, arg2 types.AccAddress) types0.DelegationI {
	m.ctrl.T.Helper()
...
func (m *MockStakingKeeper) Validator(arg0 types.Context, arg1 types.AccAddress) types0.ValidatorI {
	m.ctrl.T.Helper()
