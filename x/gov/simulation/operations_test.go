...
func TestSimulateMsgSubmitProposal(t *testing.T) {
	...
	require.Equal(t, "4031592229219368523stake", msg.InitialDeposit[0].String())
...
func TestSimulateMsgSubmitLegacyProposal(t *testing.T) {
	...
	require.NotEqual(t, len(msg.InitialDeposit), 0)
	require.Equal(t, "1885033772335167930stake", msg.InitialDeposit[0].String())
...
func TestSimulateMsgDeposit(t *testing.T) {
	...
	proposal, err := v1.NewProposal([]sdk.Msg{contentMsg}, 1, submitTime, submitTime.Add(*depositPeriod), "", "text proposal", "description", sdk.AccAddress("0x45f3624b98fCfc4D7A6b37B0957b656878636773"), false)
	require.NoError(t, err)
	...
	require.Equal(t, "280623462081924937stake", msg.Amount[0].String())
...
func TestSimulateMsgVoteWeighted(t *testing.T) {
	...
	proposal, err := v1.NewProposal([]sdk.Msg{contentMsg}, 1, submitTime, submitTime.Add(*depositPeriod), "", "text proposal", "test", sdk.AccAddress("0x45f3624b98fCfc4D7A6b37B0957b656878636773"), false)
	require.NoError(t, err)
...
func getTestingAccounts(
	...
	initAmt := stakingKeeper.TokensFromConsensusPower(ctx, 20000000000000)
