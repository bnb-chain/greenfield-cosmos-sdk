...
var (
	...
	ErrAddressSizeNotMatch     = sdkerrors.Register(ModuleName, 8, "number of old addresses does not equal to number of new addresses")
	ErrAddressNotValid         = sdkerrors.Register(ModuleName, 9, "address format is not valid")
	ErrExceedParamsChangeLimit = sdkerrors.Register(ModuleName, 10, "exceed params change limit, limit=1")
