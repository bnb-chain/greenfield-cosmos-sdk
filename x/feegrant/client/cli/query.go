...
`, version.AppName),
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			granterAddr, err := sdk.AccAddressFromHexUnsafe(args[0])
			if err != nil {
				return err
			}

			granteeAddr, err := sdk.AccAddressFromHexUnsafe(args[1])
			if err != nil {
				return err
			}
...
`, version.AppName),
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			granteeAddr, err := sdk.AccAddressFromHexUnsafe(args[0])
			if err != nil {
				return err
			}
