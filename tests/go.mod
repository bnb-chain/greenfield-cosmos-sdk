...
replace (
	...
	github.com/cometbft/cometbft => github.com/bnb-chain/greenfield-cometbft v0.0.0-20250416040433-a42e05f26f4d
	github.com/cometbft/cometbft-db => github.com/bnb-chain/greenfield-cometbft-db v0.8.1-alpha.1.0.20250416024543-3b55882962cb
