...
func ExamplePrintRegisteredTypes() {
	...
	// | ---- | ---- | ------ | ----- | ------ |
	// | PrivKeyLedgerSecp256k1 | ethermint/PrivKeyLedgerSecp256k1 | 0x4A8F6D07 | variable |  |
	...
	// | PubKey | ethermint/PubKeyEthSecp256k1 | 0xF3B3CD03 | variable |  |
	...
	// | PrivKey | ethermint/PrivKeyEthSecp256k1 | 0xFCD2EFCC | variable |  |
}
