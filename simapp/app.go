...
func NewSimApp(
	...
	keys := storetypes.NewKVStoreKeys(
		...
		evidencetypes.StoreKey, authzkeeper.StoreKey, nftkeeper.StoreKey, group.StoreKey, crosschaintypes.StoreKey,
	)
	...
	*/
	...
	var err error
	app.UpgradeKeeper, err = upgradekeeper.NewKeeper(keys[upgradetypes.StoreKey], appCodec, homePath, app.BaseApp)
	if err != nil {
		panic(err)
	}
