...
type GasInfo struct {
	...
	RwUsed uint64 `protobuf:"varint,4,opt,name=rw_used,json=rwUsed,proto3" json:"rw_used,omitempty"`
}
...
func (m *GasInfo) GetRwUsed() uint64 {
	if m != nil {
		return m.RwUsed
	}
	return 0
...
func (m *TxMsgData) GetExtraData() []byte {
	if m != nil {
		return m.ExtraData
	}
	return nil
...
var fileDescriptor_4e37629bc7eb0df8 = []byte{
	...
	,
}
...
func (m *GasInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.RwUsed != 0 {
		i = encodeVarintAbci(dAtA, i, uint64(m.RwUsed))
		i--
		dAtA[i] = 0x20
	}
...
func (m *TxMsgData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExtraData) > 0 {
		...
		i = encodeVarintAbci(dAtA, i, uint64(len(m.ExtraData)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.MsgResponses) > 0 {
...
func (m *GasInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RwUsed", wireType)
			}
			m.RwUsed = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
