...
type SignDocEip712 struct {
	// account_number is the account number of the account in state.
	AccountNumber uint64 `protobuf:"varint,1,opt,name=account_number,json=accountNumber,proto3" json:"account_number"`
	// sequence is the sequence number of the signing account.
	Sequence uint64 `protobuf:"varint,2,opt,name=sequence,proto3" json:"sequence"`
	...
	TimeoutHeight uint64 `protobuf:"varint,5,opt,name=timeout_height,json=timeoutHeight,proto3" json:"timeout_height"`
	...
	// This field is ignored if the chain didn't enable tips, i.e. didn't add the
	// `TipDecorator` in its posthandler.
	Tip *Tip `protobuf:"bytes,7,opt,name=tip,proto3" json:"tip,omitempty"`
}
...
var fileDescriptor_96d1575ffde80842 = []byte{
	...
	,
}
